...
PennController("welcome",
               ...
               .settings.css("font-size", "large")
               ,
               newText("bi3", "W&auml;hle einen bequemen und ruhigen Platz f&uuml;r die n&auml;chsten 30 Minuten! Vielen Dank!")
               .settings.center()
               .settings.css("font-size", "large")
               ,        
...
PennController("instructions",
               ...
               newImage("instructions_fingers", "instructions_wdok.jpg")
               ...
               getCanvas("instruccanvas")
               .settings.add(20,0, getText("instructions_c"))
               .settings.add (240,200, getImage("instructions_fingers"))
               .settings.add (240,600, getText("additional_fing_instr"))
               .print()
               ,
...
PennController.Template( PennController.GetTable("master_spr1_short.csv")
                         ...
                         variable => ["practice",
                                      "PennController", PennController(
                                          ...
                                          ,
                                          newText("frame1", "Dr&uuml;cke auf <b>W</b> f&uuml;r das Bild <b>oben links</b>")
                                          .settings.css("font-size", "18px").settings.color("red")
                                          .print("right at 43vw","bottom at 25vh")
                                          
                                          ,
                                          newText("frame2", "Dr&uuml;cke auf <b>O</b> f&uuml;r das Bild <b>oben rechts</b>")
                                          .settings.css("font-size", "18px").settings.color("red")
                                          .print("left at 57vw","bottom at 25vh")
                                          
                                          ,
                                          newText("frame3", "Dr&uuml;cke auf <b>D</b> f&uuml;r das Bild <b>unten links</b>")
                                          .settings.css("font-size", "18px").settings.color("red")
                                          .print("right at 43vw","top at 58vh")
                                          
                                          ,
                                          newText("frame4", "Dr&uuml;cke auf <b>K</b> f&uuml;r das Bild <b>unten rechts</b>")
                                          .settings.css("font-size", "18px").settings.color("red")
...
PennController.Template( PennController.GetTable("master_spr1_short.csv")
                         ...
                         variable => ["experiment_trial",
                                      ...
                                      ...cumulative_crit(variable.critical, "remove")    
                                          ...
                                          newCanvas("container", "70vw", "70vh")
                                          .add("center at 30%","middle at 30%",newImage("picture1",variable.picture1).css("border", "solid 1px black"))
                                          .add("center at 70%","middle at 30%",newImage("picture2",variable.picture2).css("border", "solid 1px black"))
                                          .add("center at 30%","middle at 80%",newImage("picture3",variable.picture3).css("border", "solid 1px black"))
                                          .add("center at 70%","middle at 80%",newImage("picture4",variable.picture4).css("border", "solid 1px black"))
                                          .log() 
